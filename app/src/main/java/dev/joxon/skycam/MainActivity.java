...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FloatingActionsMenu floatingActionsMenu = findViewById(R.id.FabMore);

        // Input URL
        findViewById(R.id.ButtonInputUrl).
        ...
        // Auto Trace
        findViewById(R.id.ButtonAutoTrace).
        ...
        // Upload pics
        findViewById(R.id.ButtonUploadPic).
